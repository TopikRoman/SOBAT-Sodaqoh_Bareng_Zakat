...
const TransaksiPembayaranDana = ({ route, navigation }) => {
  const { banyakZakat } = route.params;

  return (
    <View style={styles.container}>
      <Text style={styles.title}>Pembayaran Zakat - Dana</Text>
      ...
      <View style={styles.detailsContainer}>
        ...
        <Text style={styles.amount}>0895-0363-9206</Text>
...
export default TransaksiPembayaranDana;
